...
const (
	...
	// will not longer return any new events.
	subStateUnsub = 2
)
...
type Subscription struct {
	...
	// forceClosed is closed when the subscription is closed. It is used to
	// exit the blocking select.
...
func (s *Subscription) stateIsOpen() error {
